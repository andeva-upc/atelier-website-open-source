        ...
        >
            ...
            <div className="container mx-auto relative z-10 w-full max-w-7xl flex flex-col md:flex-row items-center justify-between">
                ...
                <div className="w-full md:w-auto flex-1 max-w-xl flex flex-col items-center justify-center text-center px-4 z-20">
                    ...
                    <a href="https://atelier-webapp-11848.vercel.app/sign-up" className="group rounded-md px-10 py-4 bg-[#212121] hover:bg-[#0071eb] text-white font-semibold text-lg transition-all duration-300 transform hover:scale-[1.03] active:scale-[0.98] cursor-pointer flex items-center gap-2" style={{ textDecoration: 'none' }}>
